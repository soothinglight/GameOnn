...
export default function SignUp() {
  ...
  const handleContinue = () => {
    ...
    console.log('Sign-up phone number entered:', fullPhoneNumber);
    // Navigate to signup details screen
  ...
  return (
    ...
    >
      ...
      <Text style={styles.subtext}>Enter your phone number to sign up</Text>
